...
<ul>
	<li>
		<ul>
			...
			<li>(README / Changelog) 
			Moved changelog out of README into it's own markdown file</li>
		</ul>
	</li>
	<li>
		<ul>
	...
	<li>
		<ul>
			...
			Added way to reset save data from settings, 
			alongside confimration for the player if they want to reset data</li>
		</ul>
	</li>
	<li>
		<ul>
