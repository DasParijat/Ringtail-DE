...
func action1() -> void:
	## Dash near to player
	for i in range(5): 
		base.action("move_torward_point", {"target": base.get_rand_player_pos(25, 75, 25, 75), "delay": 0, "speed": 450, "length": 0.3})
...
func action2() -> void:
	...
	for i in range(10): 
		base.action("move_torward_point", {"target": base.get_rand_player_pos(100, 600, 100, 600), "delay": 0, "speed": 350, "length": 0.2})
